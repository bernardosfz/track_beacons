...
BEACONS = {
    "Celular Sozo":"2F234454-CF6D-4A0F-ADF2-F4911BA9FFA6",
    "Celular Otavio":"967D8C06-7E9D-44C3-9E12-43DCC0E6C1F6"
}
...
async def main():
    uuid_values = list(BEACONS.values())
    targets = [uuid.lower().replace('-', '') for uuid in uuid_values]
    print(f"Procurando por Beacons...")
                        ...
                        for i, target in enumerate(targets):
                            if target in hex_data:
                                ...
                                message = {
                                    "antena": antena,
                                    "datahora": data_hora,
                                    "beacon_uuid": uuid_detectado,
                                    "beacon_nome": beacon_nome,
                                    "rssi": b.rssi,
                                    "mac": b.address
                                }
                                print(message)
